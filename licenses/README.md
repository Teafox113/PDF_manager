...
`dingbat-to-unicode-1.0.1/LICENSE` 現在是該元件自身的正式授權原文。作者已確認適用舊版，來源及回覆在同目錄 UPSTREAM-STATUS.txt。下方提到的暫行引用僅描述 2026-09-14 的歷史作法，已被正式 LICENSE 取代；引用副本保留，不作為現行授權依據。
